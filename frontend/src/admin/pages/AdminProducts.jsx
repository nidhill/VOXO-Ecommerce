...
const AdminProducts = () => {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden', position: 'relative', fontFamily: 'Inter, system-ui, sans-serif', background: 'transparent' }}>
            ...
            {/* Header */}
            <header className="products-header" style={{ padding: '32px 40px', borderBottom: '1px solid rgba(255,255,255,0.06)', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <div>
            ...
            {/* Table */}
            <div className="products-body" style={{ flex: 1, overflowY: 'auto', padding: '32px 40px' }}>
                {isLoading ? (
